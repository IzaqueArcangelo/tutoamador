...
@section('conteudo')
    ...
    <header class="intro-header" style="background-image: url( {{ Storage::disk('public')->exists($tutorial->imagemCabecalho) ? asset('/storage/'.$tutorial->imagemCabecalho) : asset("img/post-bg.jpg")}})">
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    <div class="post-heading">
                        ...
                        <span class="meta">Publicado por <a href="#">Start Bootstrap</a> on August 24, 2014</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                   {{-- <p>Never in all their history have men been able truly to conceive of the world as one: a single
                    ...
                    <blockquote>The dreams of yesterday are the hopes of today and the reality of tomorrow. Science has
                        not yet mastered prophecy. We predict too much for the next year and yet far too little for the
                        next ten.
                    </blockquote>
