        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    <h1>Cadastrar Tutorial</h1>
                    <p> Formulário de cadastro de tutoriais.</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                <form method="post" action="{{route('/salvar/tutorial')}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group form-group-lg {{$errors->has('titulo') ? 'has-error' : ''}}">
                        ...
                        <input type="text" class="form-control my-input-lg" id="titulo" name="titulo"
                    ...
                    <div class="form-group form-group-lg {{$errors->has('descricao') ? 'has-error' : ''}}">
                        ...
                        <input type="text" class="form-control my-input-lg" id="descricao" name="descricao" value="{{old('descricao')}}"
                    ...
                    <div class="form-group form-group-lg {{$errors->has('codigo') ? 'has-error' : ''}}">
                        ...
                        <input type="text" class="form-control my-input-lg" id="codigo" name="codigo"
                    ...
                    <div class="form-group form-group-lg {{$errors->has('tipo') ? 'has-error' : ''}}">
                        ...
                        <select class="form-control my-input-lg" name="tipo">
                    ...
                    <div class="form-group form-group-lg {{$errors->has('valor') ? 'has-error' : ''}}">
                        ...
                        <input type="text" class="form-control my-input-lg" id="valor" name="valor" placeholder="Preço" value="{{old('valor')}}">
                        @if ($errors->has('valor'))
                            <span class="help-block">
                    ...
                    <div class="form-group form-group-lg {{$errors->has('categorias') ? 'has-error' : ''}}">
                        ...
                        <select class="per-select selectpicker form-control my-input-lg "
                    ...
                    <div class="form-group form-group-lg {{$errors->has('escolherImagemCabecalho') ? 'has-error' : ''}}">
                        ...
                        <input type="file" class="form-control my-input-lg" id="escolherImagemCabecalho"
                    ...
                    <div class="form-group form-group-lg {{$errors->has('escolherImagemExibicao') ? 'has-error' : ''}}">
                        ...
                        <input type="file" class="form-control my-input-lg" id="escolherImagemExibicao"
                    ...
                    <div class="form-group form-group-lg {{$errors->has('postagem') ? 'has-error' : ''}}"
                        ...
                        <textarea class="form-control my-input-lg" id="postagem" name="postagem" value=""
